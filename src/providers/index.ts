import type { ContribkitConfig, Provider, ProviderName } from '../types.js'
import { getCredentials } from '../configs/credentials.js'
import { AfdianProvider } from './afdian.js'
import { CrowdinContributorsProvider } from './crowdinContributors.js'
